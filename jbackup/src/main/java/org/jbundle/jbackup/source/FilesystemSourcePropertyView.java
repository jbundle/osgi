 ...
 */
public class FilesystemSourcePropertyView extends BaseSourcePropertyView
	implements JBackupConstants
{
	 ...
	 * Constructor.
	 */
	public FilesystemSourcePropertyView()
	{
		super();
	}
	/*
	 * Constructor.
	 */
	public FilesystemSourcePropertyView(PropertyOwner propOwner,Properties properties)
	{
		this();
	...
	public void controlsToProperties()
	{
		...
		m_properties.setProperty(SOURCE_ROOT_PATHNAME_PARAM, strPathname);
	}
	/*
	 * Set the properties to the current control values.
	 */
	public void propertiesToControls()
	{
		...
		String strPathname = m_properties.getProperty(SOURCE_ROOT_PATHNAME_PARAM);
	...
	{
		return "Filesystem source properties";
	}
}