 ...
 */
public class ZipSourcePropertyView extends BaseSourcePropertyView
	implements JBackupConstants
{
	 ...
	 * Constructor.
	 */
	public ZipSourcePropertyView(PropertyOwner propOwner,Properties properties)
	{
		this();
	...
	public void controlsToProperties()
	{
		...
		m_properties.setProperty(ZIPIN_FILENAME_PARAM, strPathname);
	}
	/*
	 * Set the properties to the current control values.
	 */
	public void propertiesToControls()
	{
		...
		String strPathname = m_properties.getProperty(ZIPIN_FILENAME_PARAM);
