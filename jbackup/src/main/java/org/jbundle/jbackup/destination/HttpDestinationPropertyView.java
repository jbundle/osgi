 ...
 */
public class HttpDestinationPropertyView extends BaseDestinationPropertyView
	implements JBackupConstants
{
	 ...
	 * Constructor.
	 */
	public HttpDestinationPropertyView(PropertyOwner propOwner,Properties properties)
	{
		this();
	...
	public void addControlsToView(JPanel panel)
	{
		...
		panelMain.add(new JLabel("Root URL: ", JLabel.RIGHT));
	...
	public void controlsToProperties()
	{
		...
		m_properties.setProperty(BASE_URL_PARAM, strPathname);
	}
	/*
	 * Set the properties to the current control values.
	 */
	public void propertiesToControls()
	{
		...
		String strPathname = m_properties.getProperty(BASE_URL_PARAM);
